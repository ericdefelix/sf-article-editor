		...
		'blockQuotes' : {
			...
			types: [
				{ 
					ui_label: 'Info', 
					ui_value: 'info',
					svg: `<svg version="1.1" id="info" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
				...
				{ 
					ui_label: 'Tip', 
					ui_value: 'tip',
					svg: `<svg version="1.1" id="tip" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			...
			template: function(config) {
				...
				let setConfig = {
					...
					icon: () => {
						const body = typeof config === 'undefined' ? 
							module.exports.elems['blockQuotes'].types[0].svg : 
							(function(){
								for (let i = 0; i <= module.exports.elems['blockQuotes'].types.length - 1; i++) {
									const ui_value = module.exports.elems['blockQuotes'].types[i];
